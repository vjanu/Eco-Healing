...
class _updateFoodItemState extends State<updateFoodItem> {
  ...
  void initState() {
    ...
    nameController.text = widget.fooditems.name!;
    detailController.text = widget.fooditems.details!;
    addressController.text = widget.fooditems.address!;
    costController.text = widget.fooditems.cost!;
    filename = widget.fooditems.filename!;
  }
